    ...
    <DayPicker
      ...
      classNames={{
        ...
        day_button: cn(
          ...
          'h-9 w-9 p-0 font-normal aria-selected:opacity-100 disabled:cursor-not-allowed'
        ),
        range_end: 'day-range-end',
        selected:
          'bg-accent text-white hover:bg-accent hover:text-white focus:bg-accent focus:text-white',
        today: 'bg-slate-100 text-primary',
        outside:
          'day-outside text-muted-foreground aria-selected:bg-accent/50 aria-selected:text-muted-foreground',
        disabled: 'text-muted-foreground opacity-50 cursor-not-allowed bg-muted/30',
        range_middle:
